...
$(function(){
    $.ajax({
        ...
        for(var i = 1; i<response.length; i++){
            var $remainingStudents = $("<div class=item><ul><li>" + response[i].Name + "</li><li>" + response[i].Description + "</li><li>" + response[i].Props + "</li></ul></div>");
            $(".carousel-inner").append($remainingStudents);
        }
    });
});